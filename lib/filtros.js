...
export const FILTROS_CATALOGO = {
  ...
  // Único filtro de ámbito ACTIVO: se evalúa sobre la serie del PROPIO símbolo, no sobre una serie
  // externa. En semanal con el backtest en diario es una ventana de permiso lenta sobre operativa
  // rápida, que es su razón de ser.
  macd: {
    label: 'MACD del activo (12/26/9)',
    ambitos: ['activo'],
    intervaloConfigurable: true,
    // 12/26/9 son fijos a propósito: son los valores canónicos y no hay campos que configurar.
    params: { intervalo: 'diario' },
    campos: [],
    prepara(f, ctx) {
      const src = ctx.serieDe(f)
