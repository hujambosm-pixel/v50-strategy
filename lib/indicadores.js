...
export const CATALOGO_INDICADORES = {
  ema: {
    ...
    defectos: { periodo: 20, grosor: 2, discontinuo: true },
    params: [
  ...
  bollinger: {
    ...
    defectos: { periodo: 20, desviaciones: 2, grosor: 2, discontinuo: true },
    params: [
  ...
  rsi: {
    ...
    defectos: { periodo: 14, sobrecompra: 70, sobreventa: 30, grosor: 2 },
    params: [
  ...
  macd: {
    ...
    defectos: { rapido: 12, lento: 26, senal: 9, colorSenal: '#ff8c42', grosor: 2 },
    params: [
  ...
  volumen: {
    nombre: 'Media de volumen', destino: 'volumen',
    defectos: { periodo: 20, grosor: 2 },
    params: [
      { clave: 'periodo', etiqueta: 'Periodo', tipo: 'entero', min: 1, max: 2000 },
      { clave: 'color', etiqueta: 'Color', tipo: 'color' },
      { clave: 'grosor', etiqueta: 'Grosor', tipo: 'entero', min: 1, max: 4 },
    ],
    rotulo: (i) => `Vol MA ${i.periodo}`,
  },
}
