                            ...
                            <div style={{flex:2.5,borderRight:'1px solid var(--border)',display:'flex',flexDirection:'column',overflow:'hidden',position:'relative',minWidth:0}}>
                              ...
                              <div style={{flex:2-tlEquityFlex,position:'relative',display:'flex',flexDirection:'column',overflow:'hidden',minHeight:0}}>
                                <div ref={tlInvestContainerRef} style={{flex:1,minHeight:0,height:'100%',position:'relative'}}>
                                  {_loadingFloat&&<div style={{position:'absolute',inset:0,zIndex:5,display:'flex',alignItems:'center',justifyContent:'center',fontFamily:MONO,fontSize:9,color:'#3d5a7a',background:'var(--bg)',pointerEvents:'none'}}>⟳ Cargando precios…</div>}
                                  <div style={{height:'100%',visibility:_loadingFloat?'hidden':'visible'}}>
                                    {investData.length>1
                                      ?<TlInvestChart investData={investData} syncRef={tlDashSyncRef} patrimonyCurve={cwcDisp.length>1?cwcDisp:null} compact={false} height={tlInvestHeight} ready={!_loadingFloat}/>
